...
@keyframes slay-3 {
  ...
  100% {
		...
		<main id="listar-main" class="listar-main listar-haslayout">
			...
			<div class="listar-dashboardbanner">
				...
				<div class="listar-leftbox">
					<ol class="listar-breadcrumb">
						...
						<li class="listar-active">Add Products</li>
					</ol>
					<h1>Add Products</h1>
			...
			*************************************-->
			<div id="listar-content" class="listar-content">
				<form class="listar-formtheme listar-formaddlisting" action="{{route("selleraddproducts.store")}}" method="post" enctype="multipart/form-data">
				...
				<input type="hidden" name="created_by" value="{{ auth()->id() }}">
					...
					<div id="listar-addlistingsteps" class="listar-addlistingsteps">
								...
								<div class="row">
									<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
										<div class="form-group listar-dashboardfield">
											...
											<input type="text" name="name" class="form-control slug-title" placeholder="Enter product name">
										</div>
									</div>
									<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
										<div class="form-group listar-dashboardfield">
									...
									<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
										<div class="form-group listar-dashboardfield">
											<label>Categories</label>
											<select name="category_id" id="Categories" class="form-control" required onchange="toggleNewSubcategoryInput(this)">
												<option value="">Select a category</option>
												@foreach ($categories as $category)
													<option value="{{ $category->id }}">{{ $category->name }}</option>
												@endforeach
											...
											<input type="text" name="new_subcategory_name" id="NewSubcategoryInput" class="form-control" style="display:none;" placeholder="Enter new subcategory">
										</div>
									</div>
									...
									<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
										<div class="form-group listar-dashboardfield">
											...
											<textarea id="listar-tinymceeditor1" name="description"  class="form-control" rows="7" cols="9" height="100px"></textarea>
										</div>
									</div>
						...
						<div class="listar-steptitle"><em>upload photo</em></div>
						<section>
							<fieldset>
								<div class="listar-boxtitle">
									<h3>Upload </h3>
								...
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
									<div class="form-group listar-dashboardfield">
										<label>Gallery</label>
										<label class="listar-fileuploadlabel" for="image">
						...
						<div class="listar-steptitle"><em>Quantity </em></div>
						<section>
							<fieldset>
								<div class="listar-boxtitle">
									<h3>Mention Quantity</h3>
								</div>
								<div class="row">
						...
						<div class="listar-steptitle"><em>Price </em></div>
						<section>
							<fieldset>
								<div class="listar-boxtitle">
									<h3>Price Setting</h3>
								...
								<div class="row">
									<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
										<div class="form-group listar-dashboardfield">
											<label>Price </label>
											<input type="number" name="price"  id="price1" class="form-control" placeholder="Enter price">
								...
								<button type="submit" value="Submit" class="button button1">Submit
									<div class="icon-1">
										<svg
    ...
    var inputElement = document.getElementById('NewSubcategoryInput');
